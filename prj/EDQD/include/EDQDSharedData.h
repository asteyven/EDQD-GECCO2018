...
#ifndef EDMAPELITESSHAREDDATA_H
#define EDMAPELITESSHAREDDATA_H
...
public:
    ...
    static bool gEDQDOnlyKeepMapsForGeneration;
    static bool gEDQDIncludeLocalMapForSelectionMerge;
    static bool gEDQDMergeAllMapsIntoLocalMap;

    static const int gEDQDNbOfDimensions = 2;
	static const int gEDQDNbOfIntervals = 15;
	static double gEDQDFitEpsilon;
    ...
    static int gArenaRadius;
    
    static std::ofstream gEOGLogFile;
    static LogManager* gEOGLogManager;

    static std::ofstream gMapsLogFile;
	static LogManager* gMapsLogManager;
